	...
	$.extend($.rebox.prototype, {
		...
		open: function(i){
				...
				t.$box = $('<div class="'+ t.settings.theme +'" style="display:none;">'+
							...
							'<a href="#" class="'+ t.settings.theme +'-prev '+ t.settings.theme +'-button"><img src="/fancy_nav_left.png" />'+ t.settings.prev +'</a>' +
							'<a href="#" class="'+ t.settings.theme +'-next '+ t.settings.theme +'-button"><img src="/fancy_nav_right.png" />'+ t.settings.next +'</a>' +
